...
> **重要提示**: 本应用使用 OpenStreetMap 地图服务，在某些网络环境下可能需要配置网络代理才能正常访问。如遇地图加载问题，请检查网络连接或配置相应的代理设置。
...
> **注意**: 地图组件使用 OpenStreetMap 服务，在某些网络环境下可能需要配置网络代理才能正常访问地图瓦片。如果地图无法加载，请检查网络连接或配置相应的代理设置。
...
4. **地图无法加载**
   - 检查网络连接是否正常
   - 确认是否需要配置网络代理访问 OpenStreetMap
   - 在某些网络环境下，可能需要使用 VPN 或代理服务
